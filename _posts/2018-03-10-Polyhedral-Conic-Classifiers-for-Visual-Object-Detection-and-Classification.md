...
comments: true
classes: wide
date: 2018-03-10 17:42:32+00:00
categories:
  - Object Detection
tags:
  - Object Detection
...
![figure 1]({{ site.url }}{{ site.baseurl }}/assets/images/1511857062878.png)
...
![figure 2]({{ site.url }}{{ site.baseurl }}/assets/images/1511862432092.png)
...
![figure 3]({{ site.url }}{{ site.baseurl }}/assets/images/1511857304282.png)
...
![table 2]({{ site.url }}{{ site.baseurl }}/assets/images/1511857253908.png)
...
![table 3]({{ site.url }}{{ site.baseurl }}/assets/images/1511853331223.png)

### 3.3 视觉对象分类实验

### 3.3.1 在PASCALVOC 2017上的实验

![table 4]({{ site.url }}{{ site.baseurl }}/assets/images/1511857567916.png)

### 3.3.2 在多类分类数据集上的实验

![table 5]({{ site.url }}{{ site.baseurl }}/assets/images/1511857596135.png)

### 3.4 在开放集合识别上的实验

### 3.4.1 开放集合视觉对象分类

![table 6]({{ site.url }}{{ site.baseurl }}/assets/images/1511857617636.png)

### 3.4.2 开放集合USPS数字识别

![table 7]({{ site.url }}{{ site.baseurl }}/assets/images/1511857639216.png)
